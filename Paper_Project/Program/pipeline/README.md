...
- DOCX landscape and overwide tables: tables extracted from landscape sections
  ...
  next wide table opens its own landscape section. List-like bridge paragraphs starting with
