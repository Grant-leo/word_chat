...
images or inline formulas, the generator skips the omission restore for that
row and keeps the visible cell content instead of deleting it as a blank
...
OMML, including inside nested tables carried by the omitted zone. Source audit
