...
- DOCX landscape and overwide tables: tables extracted from landscape sections
  ...
  block children such as code, captions, and small tables, those children are
  rendered in source order instead of being batched by type. List-like bridge paragraphs starting with
