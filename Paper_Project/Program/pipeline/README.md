...
- DOCX landscape and overwide tables: tables extracted from landscape sections
  ...
  bullets or numbering are also treated as body flow rather than table notes,
  so they close the preceding landscape section and render in portrait before
  the next wide table opens its own landscape section. Complex or extreme wide tables still
