...
deep table's final-view visible text by flattening it into the parent cell
instead of silently dropping the content; source audit still keeps
seven-level-and-deeper nesting as a Word/WPS review risk. DOCX
