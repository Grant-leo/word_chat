...
- Synthetic regression after the latest WPS text-page visual fail-closed and diagnostic-artifact fixes: `200 passed, 0 failed`.
...
WPS PDF metadata/page-count/page-size/text-page validation, separate Word/WPS rendered-text diagnostics, and visual QA report writers. `checks.py` owns render QA orchestration while
