...
- Current full synthetic regression: `443 passed, 0 failed`. Latest additions:
  ...
  and `modules.get("m", codecs).decode(...)`, before they can damage Chinese
  text. Existing safe `setdefault/get/pop` entries remain unblocked.
