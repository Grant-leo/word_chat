...
- DOCX landscape and overwide tables: tables extracted from landscape sections
  ...
  media and block children such as code, images, captions, and small tables,
  those children are rendered in source order instead of being appended by the
  media collector or batched by type. List-like bridge paragraphs starting with
