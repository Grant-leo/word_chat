...
REPAIR_GUIDES = {
    ...
    "COMPLEX_TABLE_UNSUPPORTED": {
        ...
        "user_action": "生成后重点核对这些表格，尤其是 detail 里出现 irregular_tables、wide_tables、landscape_wide_tables 或 nested_depth 大于 4 的情况；若五层及以上嵌套、异常合并、极端宽表或横向宽表错位，请先运行 visual QA 并用 Word/WPS 对照原文检查，必要时再把异常表格拆成普通表格或转为清晰图片。",
